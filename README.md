...
copy the CCD ones because the namespace we used to generate these
secrets is part of the encryption (that might change in the future).

Sealed secrets can be generated by using the following script //TODO
